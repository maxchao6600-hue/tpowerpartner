export const faqItems = [
  ...
  {
    question: "Is there a Chinese version of the website?",
    answer:
      "Yes. The TPOWER Partner website is available in English and Simplified Chinese. Use the language switcher in the header to switch between EN and 中文.",
  },
  {
    question: "What is the difference between affiliate and agent programs?",
    answer:
      "The affiliate program is designed for digital marketers driving traffic through campaigns. The agent program is for partners managing player networks. Specific terms for each are provided during onboarding.",
  },
  {
    question: "When will I receive my partner credentials?",
    answer:
      "After your application is reviewed and approved, you will receive onboarding instructions and account credentials via the email provided during registration.",
  },
] as const;
